if (typeof window.HJChat === 'undefined') {
    ...
    HJChat.prototype.options = {
        ...
        'ui.conversation.user_info': function(identity, conversationElm) {},
        'ui.conversation.load_msg': function(identity, conversationElm) {},
    ...
    HJChat.prototype.openConversation = function(identity, triggerElm) {
        ...
        if (!this.isLoadedConversation(identity)) {
            ...
            this.options['ui.conversation.user_info'](identity, conversationElm);
            this.options['ui.conversation.load_msg'](identity, conversationElm);
