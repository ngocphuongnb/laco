...
class Chat extends BaseController {
    ...
    index(req, res, next) {
        ...
        libs.getConversationsByUserId(currentUserId).then(data => {
            ...
            _.each(conversations, conversation => {
                conversionTpls.push(`<li><span class="hjchat-conversation-trigger" data-sender="${conversation.sender_name}" data-identity="${conversation.identity}">${conversation.name}</span></li>`)
            });
...
<html>
    ...
    getMsg(req, res) {
        ...
        let userIdentity = req.body.userIdentity || null;
    ...
    conversation(req, res) {
        ...
        libs.getConversationsByUserId(userId).then(data => res.json({ status: 1, data }))
