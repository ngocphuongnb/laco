                ...
                cmd: (cmd, task, callback) => {
                    ...
                    gulp.task('buildCommonStyle', cb => {
                        ...
                        if (process.env.NODE_ENV == 'production') {
                            gulpObj = gulpObj
                                .pipe(cmd.gulpConcatCss('admin.min.css'))
                                .pipe(cmd.gulpCleanCSS({ compatibility: 'ie8', level: { 1: { all: true }, 2: { all: true } } }))
                        }

                        return gulpObj.pipe(gulp.dest('/css'));
                    });
                    ...
                    gulp.task('buildCommonJS', cb => {
                        ...
                        let gulpObj = gulp.src([
                            path.join(this.extDir, 'node_modules/adminbsb-materialdesign/js/admin.js'),
                            path.join(this.extDir, 'node_modules/adminbsb-materialdesign/js/helpers.js'),
                            path.join(this.extDir, 'assets/js/admin.js'),
                        ]);
                        ...
                        return gulpObj.pipe(gulp.dest('/js'));
                    });
