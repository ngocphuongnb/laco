            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active" id="media-browse">
                    <await(data from data.mediasProvider) client-reorder>
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 ready-media media-thumb" for(media in data.items)>
                            <div class="detail">
                                <div class="thumb">
                                    <img src="${media.source}" />
                                </div>
                                <div class="info">
                                    <div class="name"><span>${media.name} ${media.thumb('120x120')}</span></div>
