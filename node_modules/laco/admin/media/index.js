...
class Media extends AdminModule {
    constructor(laco) {
        ...
        let thumbRouter = () => {
            let router = new laco.express.Router()

            router.get('/data/thumbs/:filename([a-zA-Z0-9\-\_\/\.\%]+)', (req, res) => {
                media.tools.thumbGenerator(req.params.filename)
                    .then(thumbStream => thumbStream.pipe(res))
