...
var marko_template = module.exports = require("marko/html").t(__filename),
    ...
    hello_btn_template = marko_loadTemplate(require.resolve("./components/hello-btn")),
    marko_helpers = require("marko/runtime/html/helpers"),
    marko_loadTag = marko_helpers.t,
    hello_btn_tag = marko_loadTag(hello_btn_template),
...
function render(input, out) {
  ...
  out.w("<!doctype html><html><head><title>Hello World</title></head><body><h1>Hello World</h1> ");
