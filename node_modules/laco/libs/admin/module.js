...
class AdminModule extends Module {
    constructor(laco) {
        ...
        super(moduleDir, caller.getFunctionName());
            ...
            viewObj
                .then(content => {
                    ...
                    let loadedObj = {
                        ...
                        target: req.originalUrl.replace(`?pipe=${req.pipedRequest}`, '').replace(`&pipe=${req.pipedRequest}`, ''),
                        breadcrumbs: data._common.breadcrumbs
                    };
                    let html = `<script>var lacoLoadedPipe = ${JSON.stringify(loadedObj)};parent.lacoPipeObj.pipeContentExtractor(lacoLoadedPipe);</script>`;
                    res.end(html);
                })
                .catch(e => {
