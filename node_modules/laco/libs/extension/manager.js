    ...
    load(packagePath) {
        return new Promise((resolve, reject) => {
            ...
            try {
                ...
                let extObj = new ExtItem(this.laco);
                this.laco.on(`ext.${extBaseName}.init.success`, () => resolve(extObj));
                this.laco.on(`ext.${extBaseName}.init.error`, err => reject(err));
                // extObj.init(err => {
                //     err ? reject(err) : resolve(extObj);
                // });
            } catch (err) {
