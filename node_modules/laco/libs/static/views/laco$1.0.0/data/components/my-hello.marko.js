$_mod.def("/laco$1.0.0/data/components/my-hello.marko", function(require, exports, module, __filename, __dirname) { // Compiled using marko@4.2.8 - DO NOT EDIT
"use strict";
...
var marko_template = module.exports = require('/marko$4.2.8/vdom'/*"marko/vdom"*/).t(),
    ...
    marko_componentType = marko_registerComponent("/laco$1.0.0/data/components/my-hello.marko", function() {
