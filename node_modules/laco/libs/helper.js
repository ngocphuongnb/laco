...
const CRYPTO_DEFAULT_ALGORITHM = 'aes-128-cbc';
...
const encrypt2 = (text, password = process.env.CRYPTO_DEFAULT_PASSWORD, algorithm = CRYPTO_DEFAULT_ALGORITHM) => {
...
const decrypt2 = (text, password = process.env.CRYPTO_DEFAULT_PASSWORD, algorithm = CRYPTO_DEFAULT_ALGORITHM) => {
