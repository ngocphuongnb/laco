    ...
    var mediaListing = function() {
        ...
        var listener = function() {
            ...
            $(document).on('click', '#insert-medias', function() {
                ...
                if(lacoMedia.targetField != '__active_editor') {
                    if(!lacoMedia.isMulti) {
                        ...
                        $('#' + lacoMedia.targetField + '-field-thumb-image', parent.document).html(`
                            <img src="${insertMedia.thumb}" />
                        `);
                    }
                }
                else {
                    var insertTpl = [];
                    var parentEditableEditor = parent.CKEDITOR.instances.content;
