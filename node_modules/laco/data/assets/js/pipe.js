    ...
    self.init = function() {
        ...
        window.pipeContentExtractor = function(loadedPipe) {
            ...
            LacoPipe.getMultiScripts(loadedPipe.scriptFiles).done(function() {
                ...
                console.error('Error loading pipe dependencies: ' + e);
                console.error(loadedPipe);
            });
        };
        ...
        self.addHandler('link', {
            ...
            exec: function(element, event) {
                let loadPipeContent = function(targetUrl) {
                    if(targetUrl[0] == '/') {
                ...
                loadPipeContent(targetUrl);

                window.onpopstate = function(event) {
                    var popStateTarget = event ? event.state.href : self.currentState;
                    loadPipeContent(popStateTarget);
                };
            }
        })
        self.listener();
