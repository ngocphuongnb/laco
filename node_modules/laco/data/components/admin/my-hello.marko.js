...
var marko_template = module.exports = require("marko/html").t(__filename),
    ...
    marko_componentType = marko_registerComponent("/laco$1.0.0/data/components/admin/my-hello.marko", function() {
...
function render(input, out, __component, component, state) {
  ...
  out.w("<div class=\"count\"" +
    ...
    ">Click me!</button><div" +
    marko_attr("id", __component.elId("_r2")) +
    ">Hello wwd</div>");
}
    ...
    deps: [
      {
          type: "css",
          code: ".count {\n        color:#09c;\n        font-size:3em;\n    }\n    .example-button {\n        font-size:1em;\n        padding:0.5em;\n    }",
          virtualPath: "./my-hello.marko.css",
          path: "./my-hello.marko"
        },
      {
          type: "require",
