if (typeof window.HJChat === 'undefined') {
    ...
    HJChat.prototype.init = function() {
        ...
        this.socket.on('connect', function () {
            _this.socket.emit(_this.events.USER_NOTIFICATION, _this.options.userIdt);
            _this.listen();
        });
    }
    ...
    HJChat.prototype.openConversation = function(identity, triggerElm) {
        ...
        if (!this.isLoadedConversation(identity)) {
            this.socket.emit(_this.events.USER_IDENTITY, identity);
        ...
        var conversationMenuItem = $('[data-identity="' + identity + '"]');
        var sender = conversationMenuItem.data('sender');
        $(this.options['ui.form']).data('sender', sender);
        ...
        conversationMenuItem.addClass('active');
...
$(function() {
    ...
    var hjchat = new HJChat({
        ...
        'ui.msg.onnew': function (msg, isInActivatedConversaton) {
            console.log(msg);
            console.log(isInActivatedConversaton);
        }
    });
    hjchat.init();
});