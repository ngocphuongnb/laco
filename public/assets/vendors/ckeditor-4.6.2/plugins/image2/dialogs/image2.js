...
CKEDITOR.dialog.add("image2", function(f) {
    function C() {
        ...
        (a = !(!a || 0 === parseInt(a[1], 10))) || alert(c["invalid" + CKEDITOR.tools.capitalize(this.id)]);
        return a
    }
    ...
    function N() {
        ...
        return function(q, c, e) {
            ...
            b.setAttribute("src", (w.baseHref ||
                "") + q + "?" + Math.random().toString(16).substring(2))
        }
    }
    ...
    function F() {
        ...
        a !== x.data.src ? (G(a, function(a, b, c) {
            ...
            h.setValue(!1 === f.config.image2_prefillDimensions ? 0 : c);
            u = b;
            v = c;
            k(H.checkHasNaturalRatio(a))
    ...
    function I() {
        if (e) {
            var a = this.getValue();
            if (a && (a.match(D) || k(!1), "0" !== a)) {
                var b = "width" == this.id,
                    c = m || u,
                    d = n || v,
                    a = b ? Math.round(a / c * d) : Math.round(a /
                        d * c);
    ...
    function k(a) {
        if (d) {
            if ("boolean" == typeof a) {
                if (y) return;
                e = a
            } else a = g.getValue(), y = !0, (e = !e) && a && (a *= n / m, isNaN(a) || h.setValue(Math.round(a)));
    ...
    var D = /(^\s*(\d+)(px)?\s*$)|^$/i,
        ...
        O = (new CKEDITOR.template('\x3cdiv\x3e\x3ca href\x3d"javascript:void(0)" tabindex\x3d"-1" title\x3d"' + b.lockRatio + '" class\x3d"cke_btn_locked" id\x3d"{lockButtonId}" role\x3d"checkbox"\x3e\x3cspan class\x3d"cke_icon"\x3e\x3c/span\x3e\x3cspan class\x3d"cke_label"\x3e' + b.lockRatio + '\x3c/span\x3e\x3c/a\x3e\x3ca href\x3d"javascript:void(0)" tabindex\x3d"-1" title\x3d"' + b.resetSize + '" class\x3d"cke_btn_reset" id\x3d"{resetButtonId}" role\x3d"button"\x3e\x3cspan class\x3d"cke_label"\x3e' +
            b.resetSize + "\x3c/span\x3e\x3c/a\x3e\x3c/div\x3e")).output({
            lockButtonId: J,
            resetButtonId: K
        }),
        ...
        E = H.getNatural,
        r, x, L, G, m, n, u, v, l, e, y, d, p, g, h, B, M = [{
            id: "src",
            type: "text",
            label: c.url,
            onKeyup: F,
                ...
                children: [{
                    ...
                    },
                    {
                        ...
                        onLoad: function() {
                            ...
                            p = r.getById(K);
                            d && (b.addFocusable(d,
                                4 + z), d.on("click", function(a) {
                                k();
                                a.data && a.data.preventDefault()
                            }, this.getDialog()), a(d));
                            p && (b.addFocusable(p, 5 + z), p.on("click", function(a) {
                                l ? (g.setValue(u), h.setValue(v)) : (g.setValue(m), h.setValue(n));
                                a.data && a.data.preventDefault()
                            }, this), a(p))
                        },
                        setup: function(a) {
